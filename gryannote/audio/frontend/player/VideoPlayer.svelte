<!--Code originally copied from https://github.com/gradio-app/gradio/blob/main/js/video/shared/Video.svelte-->

<script lang="ts">
	import type { HTMLVideoAttributes } from "svelte/elements";
	import { createEventDispatcher } from "svelte";
	import { video_loaded } from "../shared/utils";
...
<div class="video-wrapper">
	<video
		...
		bind:paused
		bind:this={node}
		use:video_loaded={{ autoplay: autoplay ?? false }}
